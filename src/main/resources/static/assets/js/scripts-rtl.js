$(document).ready(function () {
    ...
    $('.carousel-card').owlCarousel({
        rtl: true, loop: false, margin: 10, nav: false, autoplay: false, dots: false, autoWidth: true
    })
    ...
    $('.brand-slider').owlCarousel({
        rtl: true, loop: true, margin: 15, nav: false, autoplay: false, dots: false, items: 5, responsive: {
            0: {
                items: 2,
            }, 600: {
                items: 3,
    ...
    $('.product-slider').owlCarousel({
        rtl: true, loop: true, margin: 3, autoplay: true, dots: false, responsive: {
            0: {
                items: 1,
            }, 600: {
                items: 1,
