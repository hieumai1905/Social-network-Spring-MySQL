...
// charts
Apex.chart = {
    fontFamily: 'Inter, sans-serif', fontSize: 13, fontWeight: 500, foreColor: gray
};

// chart users blue color
(function () {
    var options = {
        labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May'], series: [{
            name: '', data: [18, 34, 44, 58, 38]
        }], colors: [red], chart: {
            height: '50%', type: 'bar', toolbar: {
                show: false
            }, sparkline: {
                enabled: true
            }
        }, grid: {
            borderColor: borderColor, strokeDashArray: 0, xaxis: {
                lines: {
                    show: true
                }
            }, yaxis: {
...
(function () {
    var options = {
        labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Feb', 'Mar', 'Apr', 'May'], series: [{
            name: '', data: [35, 66, 34, 56, 98, 66, 34, 56, 18]
        }], colors: [pink], chart: {
            height: '50%', type: 'bar', toolbar: {
                show: false
            }, sparkline: {
...
(function () {
    var options = {
        labels: ['Oct', 'Nov', 'Dec', 'Jan', 'Feb'], series: [{
            name: 'New users', data: [70, 25, 44, 37, 28]
        }, {
            name: 'Users', data: [40, 16, 38, 30, 25]
        }], colors: [purple, blue], chart: {
            height: '100%', type: 'bar', toolbar: {
                show: false
            }
        }, grid: {
            borderColor: borderColor, strokeDashArray: 0, xaxis: {
        ...
        series: [80], chart: {
            ...
            radialBar: {
                startAngle: -90, endAngle: 90, track: {
                    background: borderColor, strokeWidth: '100%', margin: 0, // margin is in pixels

                }, dataLabels: {
                    name: {
                        show: false
                    }, value: {
                        offsetY: -2, fontSize: '32px', color: '#000', fontWeight: '700'
                    }
                }
            }
        }, grid: {
...
(function () {
    var options = {
        series: [44, 55, 67], colors: [blue, pink, red], chart: {
            height: 350, type: 'radialBar',
        }, plotOptions: {
            radialBar: {
                dataLabels: {
                    name: {
                        fontSize: '14px', color: '#FFF', show: false,
                    }, value: {
                        // offsetY: -1,
                        fontSize: '16px', fontSize: '44px', color: '#000', fontWeight: '700'
                    }, total: {
...
(function () {
    var options = {
        series: [25, 37, 38], colors: [blue, pink, red], chart: {
            height: '140%', type: 'donut'
        }, plotOptions: {
            pie: {
                donut: {
                    size: '60%', polygons: {
...
(function () {
    var options = {
        labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May'], series: [{
            ...
            name: '', data: [12, 34, 12, 11, 7]
        }], colors: [blue, pink], chart: {
            type: 'bar', height: '100%', stacked: true, toolbar: {
                show: false
            },
...
(function () {
    var options = {
        ...
        chart: {
            type: 'candlestick', height: 350, colors: [purple, pink], toolbar: {
                show: false
            },
...
(function () {
    var options = {
        series: [{
            name: 'series1', data: [11, 32, 45, 32, 34, 52, 41]
        }], colors: [white], chart: {
            height: '50%', type: 'line', toolbar: {
                show: false
            }, sparkline: {
...
(function () {
    var options = {
        labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'], series: [{
            name: '', data: [35, 66, 34, 56, 18, 35, 66, 34, 56, 18, 56, 18]
        }, {
            name: '', data: [12, 34, 12, 11, 7, 12, 34, 12, 11, 7, 11, 7]
        }], colors: [blue, pink], chart: {
            type: 'bar', height: '250%', stacked: true, toolbar: {
                show: false
            },
        }, responsive: [{
            breakpoint: 480, options: {
...
(function () {
    var options = {
        labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May'], series: [{
            name: '', data: [6, 14, 12, 11, 18]
        }, {
            name: '', data: [12, 7, 10, 11, 7]
        }], colors: [blue, pink], chart: {
            type: 'bar', height: '140%', stacked: true, toolbar: {
                show: false
            },
        }, responsive: [{
            breakpoint: 480, options: {
...
(function () {
    var options = {
        series: [{
            name: 'Marine Sprite', data: [76]
        }, {
            name: 'Striking Calf', data: [34]
        }], colors: [blue, borderColor], chart: {
            type: 'bar', height: 10, stacked: true, stackType: '100%', toolbar: {
                show: false
            }, sparkline: {
                enabled: true
            }
...
(function () {
    var options = {
        series: [{
            name: 'Website Blog', type: 'column', data: [440, 505, 671, 543, 427]
        }, {
            name: 'Social Media', type: 'line', data: [323, 432, 601, 514, 343]
        }], chart: {
            height: 350, type: 'line', toolbar: {
                show: false
            }
        }, stroke: {
            width: [0, 2]
        ...
        dataLabels: {
            enabled: false, enabledOnSeries: [1]
        }, labels: ['jan', 'Feb', 'Mar', 'Apr', 'May'], legend: {
            show: false
        },
    };
...
(function () {
    var options = {
        series: [67], colors: [red], chart: {
            height: '70%', type: 'radialBar',
        }, plotOptions: {
            radialBar: {
                dataLabels: {
                    name: {
                        ...
                        offsetY: -0.2, fontSize: '14px', color: '#000', fontWeight: '700', marginTop: '5px'
                    }, total: {
                        show: true, label: 'Total', formatter: function (w) {
                            // By default this function returns the average of all series. The below is just an example to show the use of custom formatter function
                            return 67 + '%';
...
(function () {
    var options = {
        series: [{
            name: 'TEAM A', type: 'column', data: [44, 11, 22, 27, 13, 22, 37]
        }, {
            name: 'TEAM B', type: 'area', data: [44, 55, 41, 67, 22, 43, 21]
        }, {
            name: 'TEAM C', type: 'line', data: [30, 25, 36, 30, 45, 35, 64]
        }],
        chart: {
            height: '150%', type: 'line', stacked: false, toolbar: {
                show: false
            }, sparkline: {
                enabled: true
            }
...
(function () {
    ...
    var options = {
        series: [14, 23, 21, 17, 15, 10, 12, 17, 21], chart: {
            type: 'polarArea', width: '100%', height: '250%',
        }, stroke: {
            colors: ['#fff']
        }, fill: {
            opacity: 0.8
...
(function () {
    ...
    var options = {
        series: [{
            ...
            type: 'bar', height: 350, stacked: true, toolbar: {
                show: false
            },
        }, plotOptions: {
            bar: {
